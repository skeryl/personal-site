...
import nightImage from '$lib/assets/images/down_south_night.jpg';
import dayImage from '$lib/assets/images/down_south_day.jpg';
...
class NoteShaderContent extends BookOfShadersContent {
	...
	private readonly downSouthDay = loadAsTexture(dayImage, (tex) => {
		this.handleResize();
		this.setImageUniforms();
	});
	private readonly downSouthNight = loadAsTexture(nightImage);
